                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-white/45 max-w-sm mb-6 leading-relaxed text-sm">
                            {siteConfig.description}. Beautiful, intuitive tools to help you manage your personal finances with confidence.
                        </p>
                    ...
                    {/* Product */}
                    <div>
                        <h4 className="font-semibold text-white mb-6 text-sm uppercase tracking-widest">Product</h4>
                        <ul className="space-y-3">
                            {footerLinks.product.map((item) => (
                                <li key={item}>
                                    <Link href="#" className="text-white/45 hover:text-white text-sm hover:translate-x-1 inline-block transition-all duration-200">
                                        {item}
                                    </Link>
                                </li>
                            ))}
                    ...
                    {/* Legal */}
                    <div>
                        <h4 className="font-semibold text-white mb-6 text-sm uppercase tracking-widest">Legal</h4>
                        <ul className="space-y-3">
